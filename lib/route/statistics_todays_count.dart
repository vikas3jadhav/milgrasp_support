...
class StatisticsTodaysCount extends StatefulWidget{

  @override
  StatisticsTodaysCountState createState() => new StatisticsTodaysCountState();
}

class StatisticsTodaysCountState extends State<StatisticsTodaysCount>{
    ...
    return Container(
      ...
      child: GridView.builder(
          ...
          itemBuilder: (context, item) {
            ...
            var attended_by = todaysData[item].attended_by== null ? "N/A" : todaysData[item].attended_by;
        return Container(
                child:Card(
